...
T = TypeVar("T", bound="ListReviewsResponse200")


@_attrs_define
class ListReviewsResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = Review.from_dict(results_item_data)
        ...
        list_reviews_response_200.additional_properties = d
        return list_reviews_response_200
